...
const ManagerDashboard = () => {
  const [managerName, setManagerName] = useState("Sam Wilson");
    ...
    const fetchData = async () => {
      try {
        ...
        if (managerResponse.data) {
          setManagerName(managerResponse.data.name || "Manager");
        }
  ...
  return (
    <div className="min-h-screen w-full flex justify-center bg-blue-100 fixed inset-0 text-white">
      <div className="relative z-10 flex flex-col min-h-screen p-4 lg:p-6 w-full">
        ...
        {/* <ActionButtons
          onAction1={handleAssignProject}
          onAction2={handlePerformanceReview}
          onAction3={handleTeamCalendar}
          action1Label="Assign Project"
          action2Label="Performance Reviews"
          action3Label="Team Calendar"
        /> */}
